...
public class RTO_Finned_Report extends AppCompatActivity {

    String json_url,sid;
    ProgressBar progressBar;
    ProgressDialog progressDoalog;
    ArrayList<HashMap<String, String>> post_arryList;
   vehical_recyclerAdapter_7 demo_recyclerAdapter_7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_r_t_o__finned__report);
        ...
        progressBar=(ProgressBar)findViewById(R.id.pg_7);

        recyclerView_demo=(RecyclerView)findViewById(R.id.recycler_vehical_7);
        layoutManager_demo = new LinearLayoutManager(RTO_Finned_Report.this, LinearLayoutManager.VERTICAL, false);
        recyclerView_demo.setLayoutManager(layoutManager_demo);

        demo_recyclerAdapter_7 = new vehical_recyclerAdapter_7(RTO_Finned_Report.this,post_arryList);
        recyclerView_demo.setAdapter(demo_recyclerAdapter_7);
        load_data();
    }
    ...
    {
        {
            progressDoalog = new ProgressDialog(RTO_Finned_Report.this);
            progressDoalog.setMessage("Loading....");
            progressDoalog.show();

            json_url = "http://vsproi.com/RTO/rto_vehicle_fine_list.php?uid="+sid;
            ...
            MySingleton.getInstance(RTO_Finned_Report.this).addToRequestque(jsonObjectRequest);
        }
        if (demo_recyclerAdapter_7 != null) {
            demo_recyclerAdapter_7.notifyDataSetChanged();
            System.out.println("Adapter " + demo_recyclerAdapter_7.toString());
        }
    }

    public class vehical_recyclerAdapter_7 extends RecyclerView.Adapter<vehical_recyclerAdapter_7.DemoViewHolder>
    {
        Context context;
        ArrayList<HashMap<String, String>> img_list;

        public vehical_recyclerAdapter_7(Context context, ArrayList<HashMap<String, String>> quans_list) {
            this.img_list = quans_list;
            this.context = context;
        }
        @Override
        public vehical_recyclerAdapter_7.DemoViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_1, parent, false);
            vehical_recyclerAdapter_7.DemoViewHolder ViewHolder = new vehical_recyclerAdapter_7.DemoViewHolder(view);
            return ViewHolder;
        }
        @Override
        public void onBindViewHolder(vehical_recyclerAdapter_7.DemoViewHolder merchantViewHolder, final int position)
        {
