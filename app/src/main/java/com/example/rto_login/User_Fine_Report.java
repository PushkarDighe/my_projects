...
public class User_Fine_Report extends AppCompatActivity {

    String json_url,sid;
    ProgressBar progressBar;
    ProgressDialog progressDoalog;
    ArrayList<HashMap<String, String>> post_arryList;
    vehical_recyclerAdapter_10 demo_recyclerAdapter_10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user__fine__report);
        ...
        try{
            sid = b.getString("user_id");
            toolbar_title.setText(b.getString("title"));
        }
        catch (Exception e){}

        post_arryList = new ArrayList<HashMap<String, String>>();
        progressBar=(ProgressBar)findViewById(R.id.pg_10);

        recyclerView_demo=(RecyclerView)findViewById(R.id.recycler_vehical_10);
        layoutManager_demo = new LinearLayoutManager(User_Fine_Report.this, LinearLayoutManager.VERTICAL, false);
        recyclerView_demo.setLayoutManager(layoutManager_demo);

        demo_recyclerAdapter_10 = new vehical_recyclerAdapter_10(User_Fine_Report.this,post_arryList);
        recyclerView_demo.setAdapter(demo_recyclerAdapter_10);
        load_data();
    ...
    {
        {
            progressDoalog = new ProgressDialog(User_Fine_Report.this);
            progressDoalog.setMessage("Loading....");
            progressDoalog.show();

            json_url = "http://vsproi.com/RTO/user_vehicle_fine_list.php?vid="+sid;
            ...
            MySingleton.getInstance(User_Fine_Report.this).addToRequestque(jsonObjectRequest);
        }
        if (demo_recyclerAdapter_10 != null) {
            demo_recyclerAdapter_10.notifyDataSetChanged();
            System.out.println("Adapter " + demo_recyclerAdapter_10.toString());
        }
    }

    public class vehical_recyclerAdapter_10 extends RecyclerView.Adapter<vehical_recyclerAdapter_10.DemoViewHolder>
    {
        Context context;
        ArrayList<HashMap<String, String>> img_list;

        public vehical_recyclerAdapter_10(Context context, ArrayList<HashMap<String, String>> quans_list) {
            this.img_list = quans_list;
            this.context = context;
        }
        @Override
        public vehical_recyclerAdapter_10.DemoViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_1, parent, false);
            vehical_recyclerAdapter_10.DemoViewHolder ViewHolder = new vehical_recyclerAdapter_10.DemoViewHolder(view);
            return ViewHolder;
        }
        @Override
        public void onBindViewHolder(vehical_recyclerAdapter_10.DemoViewHolder merchantViewHolder, final int position)
        {
