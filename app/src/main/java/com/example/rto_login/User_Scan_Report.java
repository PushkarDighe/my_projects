...
public class User_Scan_Report extends AppCompatActivity {

    String json_url,sid;
    ProgressBar progressBar;
    ProgressDialog progressDoalog;
    ArrayList<HashMap<String, String>> post_arryList;
    vehical_recyclerAdapter_9 demo_recyclerAdapter_9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user__scan__report);
        ...
        progressBar=(ProgressBar)findViewById(R.id.pg_9);

        recyclerView_demo=(RecyclerView)findViewById(R.id.recycler_vehical_9);
        layoutManager_demo = new LinearLayoutManager(User_Scan_Report.this, LinearLayoutManager.VERTICAL, false);
        recyclerView_demo.setLayoutManager(layoutManager_demo);

        demo_recyclerAdapter_9 = new vehical_recyclerAdapter_9(User_Scan_Report.this,post_arryList);
        recyclerView_demo.setAdapter(demo_recyclerAdapter_9);
        load_data();
    }
    ...
    {
        {
            progressDoalog = new ProgressDialog(User_Scan_Report.this);
            progressDoalog.setMessage("Loading....");
            progressDoalog.show();
            json_url = "http://vsproi.com/RTO/user_vehicle_scaned_list.php?vid="+sid;
            ...
            MySingleton.getInstance(User_Scan_Report.this).addToRequestque(jsonObjectRequest);
        }
        if (demo_recyclerAdapter_9 != null) {
            demo_recyclerAdapter_9.notifyDataSetChanged();
            System.out.println("Adapter " + demo_recyclerAdapter_9.toString());
        }
    }
    public class vehical_recyclerAdapter_9 extends RecyclerView.Adapter<vehical_recyclerAdapter_9.DemoViewHolder>
    {
        Context context;
        ArrayList<HashMap<String, String>> img_list;

        public vehical_recyclerAdapter_9(Context context, ArrayList<HashMap<String, String>> quans_list) {
            this.img_list = quans_list;
            this.context = context;
        }
        @Override
        public vehical_recyclerAdapter_9.DemoViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_1, parent, false);
            vehical_recyclerAdapter_9.DemoViewHolder ViewHolder = new vehical_recyclerAdapter_9.DemoViewHolder(view);
            return ViewHolder;
        }
        @Override
        public void onBindViewHolder(vehical_recyclerAdapter_9.DemoViewHolder merchantViewHolder, final int position)
        {
